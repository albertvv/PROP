...
public class driver {
    ...
    private void modificar_relacio(){
        ...
        System.out.print("Escriu el path o null: ");
        String path = sc.next();
        if(path.equals("null")) path = null;
        System.out.print("Escriu la descripcio o null: ");
        String descripcio = sc.next();
        if(descripcio.equals("null")) descripcio = null;
        if((path == null) && (descripcio == null) &&(nomNou == null)) System.out.println("Res a modificar");
        else {
            if (ctrdom.modificar_relacio(nom, nomNou, path, descripcio)) System.out.println("Relacio modificada");
